...
export const SUBAGENT_SPAWN_PARAMETER_DESCRIPTIONS = {
  ...
  reasoningEffort:
    "Optional thinking override on the shared off/minimal/low/medium/high/xhigh/max scale. Defaults by task_kind: medium for general/code_research/isolated_implementation, high for code_review/large_refactor/test_authoring, and xhigh for algorithmic. Pi uses it directly, Codex clamps it to model support, Claude maps it to a thinking budget, and Kiro ignores it.",
};
