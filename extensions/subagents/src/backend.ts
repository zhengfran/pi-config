 ...
 * (pi, Claude Code, Codex, Kiro), all producing the same `SubagentSession`
 * shape.
 *
 ...
 * - kiro: one `kiro-cli chat --no-interactive` child process per turn; no
 *   event protocol, so output is scraped and continuity is textual.
 */
